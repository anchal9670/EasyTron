...
<?php include('sidebar.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <h3 class="text-center text-success" style="font-family: 'Playfair Display', serif;">Autopool Income History</h3>
            ...
            <table class="table table-striped">
              <thead class="text-center">
                <tr class="d-flex">
                  ...
                  <th class="col bg-secondary">Pool</th>
              ...
              <?php
                    ...
                    $sql = "SELECT * FROM levelhistory WHERE email = '$email' and pool!=0 ORDER BY Sno desc";
                    ...
                    if($num>0){
                        while($pin=mysqli_fetch_array($queryfire)){
                            ...
                            <td class='col'>$i</td>
                            <td class='col'>$pin[pool]</td>
                            <td class='col'>$pin[trx]</td>
                            <td class='col'>$pin[date]</td>
                            <td class='col text-success'>$pin[Status]</td>
                            </tr>";
                            $i=$i+1;
                        }
                    }
