<?php 
    ...
    $html="<h3 style='color:blue;'>Easy Tron</h3>Your One Time Passwod is <h3 style='color:blue;'>589674</h3> ";
    $from="EasyTron@easytron.xyz";
    $to="anchalksai@gmail.com";
